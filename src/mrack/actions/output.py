...
class Output(Action):
    ...
    def __init__(
        ...
        self._ansible_path = (
            ansible_path or global_context.CONFIG.ansible_inventory_path()
        )
        self._pytest_multihost_path = (
            pytest_multihost_path or global_context.CONFIG.pytest_multihost_path()
        )
